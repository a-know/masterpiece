...
<html>
  <head>
    ...
    <title>メッセージを送る - Masterpiece(β) あなたの愛用品、教えてください。</title>
        ...
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <c:if test="${!loginUser}" >
              <li class="nav-header">コミュニケーション</li>
              <li class="active"><a href="/user/<c:out value="${loginID_this_page}" />/sendMessage"><i class="icon-envelope icon-white" ></i><c:out value="${loginID_this_page}" />さんにメッセージを送る</a></li>
              </c:if>
            </ul>
          </div><!--/.well -->
        ...
        <div class="span9" id="settingshead">
          ...
          <c:if test="${!flg}" >
            ...
            <div class="section">
              ...
              <h3><i class="icon-envelope icon-white" ></i> <c:out value="${loginID_this_page}" />さんにメッセージを送る</h3>
              </div>
              <div class="content">
                送信者名（省略可）<span id="messageSenderError" style="color:red;"></span><br>
                <input type="text" placeholder="送信者名を入力（省略可）" name="messageSender" id="messageSender" class="span7" value="${sessionScope.loginID}" style="margin:0 0 0 15px;" /><br><br>
                メッセージの本文<span id="sendMessageContentError" style="color:red;"></span>
                <div class="input">
                  <textarea rows="3" name="sendMessageContent" id="sendMessageContent" class="xxlarge" placeholder="メッセージの本文を入力"  style="margin:0 0 0 15px;"></textarea>
                </div><br>
                <div id="messageSending" style="margin:0 0 0 15px;"></div>
                <div align="right">
                  <button class="btn btn-success" id="sendMessageButton" style="margin:0 60px 5px 0;"><i class="icon-envelope icon-white" ></i> メッセージを送信</button>
                </div>
              </div>
            </div>
            </c:if>
