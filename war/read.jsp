...
<html>
  <head>
    ...
    <title>メッセージを読む - Masterpiece(β) あなたの愛用品、教えてください。</title>
    ...
    <!-- Le styles -->
    <link href="../../../css/bootstrap_read.css" rel="stylesheet">
        ...
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="/user/<c:out value="${loginID_this_page}" />/message"><i class="icon-envelope icon-white" ></i>メッセージを確認する</a></li>
              </c:if>
              <c:if test="${!loginUser}" >
              <li class="nav-header">コミュニケーション</li>
        ...
        <div class="span9" id="settingshead">
          ...
          <c:if test="${flg}" >
            ...
            <div class="section">
              ...
              <h3><i class="icon-envelope icon-white" ></i> メッセージを確認する</h3>
              </div>
              <div class="content">
                ...
                <c:if test="${!flg}" >
                  <div class="input" align="center">
                    <select id="messageSelect" name="messageSelect" class="span7">
                      <option value="">メッセージを選択し、下のアイコンをクリックして下さい。</option>
                  ...
                  <div align="right">
                   <p><a class="btn btn-danger" id="deleteMessageButton"><i class="icon-exclamation-sign icon-white" ></i> 選択中のメッセージを削除</a></p>
                  </div>
                  <hr>
                  <div align="center">
                  <img src="../../../images/message_icon.png" class="class_box_shadow" id="messageIconHref" rel="popover" title="－" data-content="（メッセージを選択して下さい）">
                  ...
                  <div id="messageModal" class="modal hide fade">
                    ...
                    <div class="modal-body">
                      現在選択されているメッセージを削除します。<br>
                      <br>
                      <div class="controls" style="padding: 0 0 0 30px;">
                        <li>メッセージが削除されたことは、相手に通知されることはありません。</li>
                    ...
                    <div class="modal-footer">
                      <a href="#" class="btn btn-danger" id="deleteMessageButtonOnModal">削除する</a>
