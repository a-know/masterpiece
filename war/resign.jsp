...
<html>
  <head>
    ...
    <title>退会する - Masterpiece(β) あなたの愛用品、教えてください。</title>
  ...
  <body>
        ...
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="/user/<c:out value="${loginID_this_page}" />/resign"><i class="icon-off icon-white" ></i>退会</a></li>
        ...
        <div class="span9" id="settingshead">
          ...
          <c:if test="${flg}" >
            ...
            <div class="section">
              ...
              <h3><i class="icon-off icon-white" ></i> 退会</h3>
              </div>
              <div class="content">

                <br>
                <div align="center">
                   <p><a class="btn btn-large btn-danger" id="resignButton"><i class="icon-exclamation-sign icon-white" ></i> 退会する</a></p>
                </div>
                <br>
                <div class="controls" style="padding: 0 0 0 30px;">
                  <li>このボタンを押すと、Masterpieceからの退会処理が行われます。</li>
                  <li>退会処理が行われると、今までに投稿されたあなたのMasterpiece情報とアクティビティ情報、あなたのMasterpieceページなど、すべての情報が削除されます。</li>
                  <li>一度退会処理を行うと、元の状態に戻すことはできません。</li>
                </div>

                <div id="resignModal" class="modal hide fade">
                  <div class="modal-header">
                    <a class="close" data-dismiss="modal" >&times;</a>
                    <h3>退会する</h3>
                  </div>
                  <div class="modal-body">
                    Masterpieceからの退会処理を行います。<br>
                    <br>
                    <div class="controls" style="padding: 0 0 0 30px;">
                      <li>退会処理が行われると、今までに投稿されたあなたのMasterpiece情報とアクティビティ情報、あなたのMasterpieceページなど、すべての情報が削除されます。</li>
                      <li>一度退会処理を行うと、元の状態に戻すことはできません。</li>
                    ...
                    <br>
                    本当によろしいですか？
                    <div id="resignModalLoadingZone" align="center"></div>
                  </div>
                  <div class="modal-footer">
                    <a href="#" class="btn btn-danger" id="resignButtonOnModal">退会する</a>
    ...
    <script type="text/javascript" src="../../../js/resign.js"></script>
