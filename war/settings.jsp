...
<html>
  <head>
    ...
    <title>設定 - Masterpiece(β) あなたの愛用品、教えてください。</title>
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <c:if test="${!noUser}" >
        ...
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="/user/<c:out value="${loginID_this_page}" />/settings"><i class="icon-cog icon-white" ></i>設定</a></li>
        ...
        <div class="span9" id="settingshead">

          <div class="row-fluid">
          <c:if test="${settingsChangeSuccess == 'success'}" >
          <div class="alert alert-success"><a class="close" data-dismiss="alert" href="#">&times;</a>設定の変更が完了しました。</div>
          </c:if>
          ...
          <c:if test="${flg}" >
            ...
            <div class="section">
              ...
              <h3><i class="icon-cog icon-white" ></i> 設定</h3>
              </div>
              <div class="content">


                <form method="post" action="" name="settingsForm" id="settingsForm" enctype="multipart/form-data">
                <input type="hidden" name="settingTargetLoginID" value="<c:out value="${sessionScope.loginID}" />">
                ...
                <table class="table">
                  <tbody>
                    ...
                    <tr>
                      <th>URL<br>（ブログなど）</th>
                      <td><input type="url" placeholder="URL（ブログなど）を入力" name="inputUrl" id="inputUrl" class="span7" value="<c:out value="${user.url}" />"/><span class="" id="settings-input-url-message" style="color:red;"></span></td>
                    </tr>
                    <tr>
                      <th>自己紹介<br>（200文字以内）</th>
                      <td>
                        <div class="input"><textarea rows="3" name="inputIntroduction" id="inputIntroduction" class="xxlarge" placeholder="自己紹介を入力"><c:out value="${user.introduction}" /></textarea><span class="" id="settings-input-introduction-message" style="color:red;"></span></div>
                        <input type="hidden" name="inputIntroductionHidden" id="inputIntroductionHidden">
                      </td>
                    </tr>
                    <tr>
                      <th>アイコン</th>
                      <td>
                        <img src="<c:out value="${user.imageUrl}" />" style="margin: 0 15px 0 0;"><input class="input-file" id="iconFileInput" type="file" name="iconFileInput"><span class="" id="settings-input-icon-message" style="color:red;"></span>
                        <li>利用可能なファイル形式は、JPEG・GIF・PNGです。</li>
                        <li>画像は横幅48pxを基準にリサイズされます。</li>
                        <li>著作権・肖像権の侵害になる画像、または閲覧者が不快に感じる・公序良俗に反する画像の利用は禁止しています。</li>
                        <input type="hidden" value="" id="iconFileExists" name="iconFileExists">
                      </td>
                    </tr>
                    <tr>
                      <th>Twitter連携</th>
                      <td>
                        ...
                        <c:if test="${'' == user.twitterAccessToken}" >
                          <a href="/twitterOauth">未連携・連携する</a><br>
                    ...
                    <tr>
                      <th></th>
                      <td><div id="settingLoadingZone" align="center"></div><div align="right"><a href="#settingshead" class="btn btn-primary" id="saveSettingsButton" style="margin:0 60px 0 0;">変更を保存する</a></div></td>
                    </tr>
                  </tbody>
                </table>
                </form>
