...
<html>
  <head>
    ...
    <title><c:out value="${loginID_this_page}" />'s Masterpiece List - Masterpiece(β) あなたの愛用品、教えてください。</title>
      ...
      <c:if test="${!noUser}" >
        ...
        <div class="span3">
          ...
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="/user/<c:out value="${loginID_this_page}" />/list"><i class="icon-tags icon-white" ></i>Masterpiece リスト</a></li>
              <c:if test="${loginID_this_page == sessionScope.loginID}" var="loginUser" />
              <c:if test="${loginUser}" >
        ...
        <div class="span9">
          ...
          <div class="section" style="clear:both;">
            ...
            <h3><i class="icon-tags icon-white" ></i> <c:out value="${loginID_this_page}" />さんのMasterpiece一覧</h3>
            </div>
            <div class="content">
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td><a href="/user/<c:out value="${loginID_this_page}"/>/item/<c:out value="${itemKeyList[status.index]}" />" style="text-decoration: underline;" target="_blank"><c:out value="${item.name}" /></a></td>
                  <td><c:out value="${categoryNameList[status.index]}" /></td>
          ...
          <div class="pagination pagination-centered">
            <ul>
              ...
              <li class="active"><a href="/user/<c:out value="${loginID_this_page}" />/list/<c:out value="${status.index}" />"><c:out value="${status.index}" /></a></li>
              </c:if>
              <c:if test="${!currentPageFlg}" >
              <li><a href="/user/<c:out value="${loginID_this_page}" />/list/<c:out value="${status.index}" />"><c:out value="${status.index}" /></a></li>
              </c:if>
              </c:forEach>
            </ul>
          </div>
